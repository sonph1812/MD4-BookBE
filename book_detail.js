                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <div class="tab-content pt-0">
                                                <div class="tab-pane active show" id="product-1-item">
                                                    <img src="../assets/images/products/demen.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                                                </div>
...
<!--                                            </ul>-->
                                        ...
                                        <div class="col-lg-7">
                                            <div class="pl-xl-3 mt-3 mt-xl-0">
                                                <a href="#" class="text-primary">${data[i].name}</a>
                                                <h4 class="mb-3">${data[i].description}</h4>
                                                ...
                                                <h4 class="mb-4">Price : <span class="text-muted mr-2"><del>$80 USD</del></span> <b>${data[i].price}</b></h4>
